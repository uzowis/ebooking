<?php
include('controllers/update_listing.php');
...
if(isset($_GET['del'])){
	...
	$delete_hotel = mysqli_query($db, "DELETE FROM hotels WHERE id='$hotel_id'");
	
	if ($delete_hotel){
	header('location: dashboard-listing-table.php');
}else{
	echo mysqli_error($delete_hotel);
}
        ...
        <div id="main">
                                ...
                                <div class="dashboard-content fl-wrap">
                                    ...
                                    <div class="profile-edit-container">
                                        <div class="custom-form">
                                            ...
                                            <input type="text" name="h_name" placeholder="Name of your Hotel" value="<?php echo $hotel['h_name']; ?>" required/>
                                            <input type="hidden" name="hotel_id" placeholder="Name of your Hotel" value="<?php echo $hotel_id; ?>" required/>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>Type / Category</label>
                                                    <div class="listsearch-input-item">
                                                        <select data-placeholder="Apartments" name="type"class="chosen-select no-search-select"  value="" required>
                                                            <option><?php echo $hotel['type']; ?></option>
                                                ...
                                                <div class="col-md-6">
													...
													<input type="text" name="avg_cost" placeholder="Average cost per night" value="<?php echo $hotel['avg_cost']; ?>" required />
                                                </div>
                                            </div>
											<div class="col-md-6">
                                                    <label> Website <i class="far fa-globe"></i>  </label>
													<input type="text" name="h_website" placeholder="www.example.com" value="<?php echo $hotel['website']; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-edit-container">
                                        <div class="custom-form">
                                            ...
                                            <input type="text" name="h_address" placeholder="Address of your Hotel" value="<?php echo $hotel['h_address']; ?>" required/>
											...
											<div class="row">
                                                <div class="col-md-6">
													...
													<div class="listsearch-input-item">
														<select data-placeholder="City" name="h_state" class="chosen-select no-search-select"  required >
															<option><?php echo $hotel['h_state']; ?></option>
															<option >Abia</option>
															<option >Abuja</option>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" placeholder="City" name="h_city" value="<?php echo $hotel['h_city']; ?>" required/>
                                                </div>
                                            </div>
											...
											<div class="row">
                                                <div class="col-md-6">
													...
													<input type="text" placeholder="Hotel Phone Number" name="h_phone" value="<?php echo $hotel['h_phone']; ?>"/>
                                                </div>
                                                <div class="col-md-6">
                                                    <label>Email <i class="fa fa-envelope"></i></label>
                                                    <input type="text" placeholder="Hotel Email" name="h_email" value="<?php echo $hotel['h_email']; ?>"/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="profile-edit-container">
                                        <div class="custom-form">
                                            ...
                                            <textarea cols="40" rows="3" name="h_about" placeholder="Details"><?php echo $hotel['details']; ?></textarea> 
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <ul class="fl-wrap filter-tags" style="margin-top:24px">
                                                    ...
                                                    <li>
                                                        <input id="check-ff51" type="checkbox" name="check" checked>
                                                        <label for="check-ff51">Swimming Pool</label>
                                                    </li>
                                                </ul>
            ...
            <footer class="main-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="footer-widget fl-wrap">
                                    ...
                                    <a href="https://twitter.com/EbookingN" class="twitter-link" target="_blank">Follow</a>
                                </div>
                            </div>
                            <!--footer-widget end-->
                        </div>
                ...
                <div class="sub-footer">
                    <div class="container">
                        <div class="copyright"> &#169; E-booking.ng 2020 .  All rights reserved.</div>

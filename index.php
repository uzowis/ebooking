                        ...
                        <div class="hero-section-wrap fl-wrap">
                            <div class="container">
                                <div class="home-intro">
                                    ...
                                    <h3>Let's start exploring the world together with Ebooking.com.ng</h3>
                                </div>
                                <div class="main-search-input-wrap">
                                    <div class="main-search-input fl-wrap">
                                        <form action="listing.php" method="get">
                                            <div class="main-search-input-item location" id="">
                                            ...
                                            <div class="main-search-input-item main-date-parent main-search-input-item_small">
                                                <span class="inpt_dec"><i class="fal fa-calendar-check"></i></span> <input style="color: #666666;" type="text" placeholder=""   value="<?php echo date('d/M/Y')?>"/>
                                            </div>
                                            ...
                                            <div class="slick-slide-item">
                                                <div class="hotel-card fl-wrap title-sin_item">
                                                    <div class="geodir-category-img card-post">
                                                        <a href="listing-single.php?id=<?php echo $result_['id']?>"><img src="./images/hotel_imgs/<?php echo $img_result2['images']?>" alt=""></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="process-item big-pad-pr-item">
                                        ...
                                        <h4> <a href="#">Best Hotel Deals</a></h4>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="process-item big-pad-pr-item nodecpre">
                                        ...
                                        <h4><a href="#"> Frequent Discount Offers</a></h4>
                                        <p>Mouth watery discounts.</p>
                                    </div>
                                    <!-- process-item end -->                                
                                </div>
                            </div>
                                    ...
                                    <div class="colomn-text fl-wrap">
                                        <div class="colomn-text-title" >
                                            ...
                                            <div style="align-items: center">
                                                <a target="_blank" style="padding-top: 7px" href="./agreement.pdf" class=" down-btn color3-bg"><i class="fab fa-android"></i> Agreement</a>
